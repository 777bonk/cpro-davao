import { LayoutDashboard, Calendar, ClipboardList, Settings, LogOut, Car, Users, Globe } from "lucide-react";
...
export function FrontDeskSidebar({ activeSection, onSectionChange }: FrontDeskSidebarProps) {
