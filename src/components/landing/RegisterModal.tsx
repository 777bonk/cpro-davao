    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          <p className="text-white/60 text-center text-sm mb-8">Join Ceramic Pro Davao today.</p>
          ...
          {successMsg && <div className="mb-4 p-3 bg-green-500/10 border border-green-500/30 text-green-400 text-sm rounded-lg text-center">{successMsg}</div>}
          ...
          <p className="text-center text-sm text-white/50 mt-8">
            Already have an account? <button type="button" onClick={onSwitchToLogin} className="text-[#E41E6A] hover:underline font-medium">Sign in</button>
          </p>
        </div>
      </div>
    </div>
