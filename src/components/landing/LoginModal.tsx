        ...
        <div className="p-8">
          ...
          <form onSubmit={handleManualLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-gradient-to-r from-[#E41E6A] to-pink-600 text-white border-none hover:opacity-90 mt-4"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 text-white/50" style={{ backgroundColor: "#0a0a0a" }}>
                Or continue with
              </span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-11 border-white/10 bg-white/5 text-white hover:bg-white/10 flex items-center justify-center gap-2"
          >
          ...
          <p className="text-center text-sm text-white/50 mt-8">
            ...
            <button
              ...
              className="text-[#E41E6A] hover:underline font-medium"
            >
              Sign up
            </button>
          </p>
